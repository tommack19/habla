...
export const PRACTICE_LIBRARY_CATEGORIES = [
  {
    ...
    sections: [section("Real-life Spanish", [
      ...
      item("family", "Family", { practiceTopic: "family", lessonIds: ["lesson-03-family"] }),
      item("restaurants", "Restaurants", { practiceTopic: "food-restaurants", lessonIds: ["lesson-06-food-drinks"] }),
      item("travel", "Travel", { practiceTopic: "travel", lessonIds: ["lesson-07-travel-basics", "lesson-08-vacation"] }),
  ...
  },
  {
    ...
    collections: [
      ...
      collection("present-tense", "Present Tense", 3, "lessons", [lessonItem("regular-present", "Regular Present Tense", ["lesson-14-work"]), lessonItem("ser-vs-estar", "Ser vs Estar", ["a1-lesson-02-introductions", "lesson-19-emotions"], { libraryContent: { kind: "grammar", explanation: "Use ser for identity, origin, profession, time, and defining traits. Use estar for location and states or conditions that can change.", examples: [{ spanish: "Soy canadiense.", english: "I am Canadian." }, { spanish: "Estoy cansado.", english: "I am tired." }, { spanish: "La tienda está aquí.", english: "The store is here." }], commonMistake: "Location normally uses estar—even for permanent locations: Madrid está en España." } }), lessonItem("stem-changing-verbs", "Stem-changing Verbs", ["lesson-05-shopping"])]),
      collection("past-tense", "Past Tense", 2, "lessons", [], { locked: true, level: "A2" }),
      collection("future", "Future", 2, "lessons", [lessonItem("near-future", "Ir a + Infinitive", ["lesson-08-vacation"]), lessonItem("future-plans", "Talking About Future Plans", ["lesson-08-vacation"])]),
      collection("comparisons", "Comparisons", 1, "lesson", [lessonItem("basic-comparisons", "Más, Menos & Tan", ["lesson-05-shopping"])]),
      collection("prepositions", "Prepositions", 2, "lessons", [lessonItem("location-prepositions", "Location Words", ["lesson-09-around-the-house"]), lessonItem("a-de-en", "A, De & En", ["lesson-07-travel-basics"])]),
