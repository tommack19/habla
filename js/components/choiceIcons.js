const CHOICE_ICON_PATHS = Object.freeze({
  ...
  "wave-away": `<path d="M8.35 11.65V7.1a1.45 1.45 0 0 1 2.9 0v3.15M11.25 10.25V5.35a1.45 1.45 0 0 1 2.9 0v4.9M14.15 10.25V6.5a1.45 1.45 0 0 1 2.9 0v5.15M17.05 11.65V9a1.45 1.45 0 0 1 2.9 0v5c0 4.45-3.05 7.2-7.25 7.2-2.9 0-5.15-1.35-6.65-3.9l-2.3-3.85a1.55 1.55 0 0 1 2.4-1.9l2.2 2.1Z"/><path d="M3 4h5M6 2l2 2-2 2M19.5 4.5l1.2-1.5"/>`,
  ...
  people: `<circle cx="8" cy="8" r="3"/><circle cx="16.5" cy="9" r="2.5"/><path d="M2.8 20c.5-4.2 2.3-6.3 5.2-6.3s4.7 2.1 5.2 6.3M13.2 14.5c.9-.8 2-1.2 3.3-1.2 2.5 0 4.1 1.8 4.5 5.5"/>`,
  smile: `<circle cx="12" cy="12" r="9"/><path d="M8.4 9.75h.01M15.6 9.75h.01M8.25 14.1c.95 1.35 2.2 2.05 3.75 2.05s2.8-.7 3.75-2.05"/>`,
  "speech-question": `<path d="M5 5h14a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-8l-5 4v-4H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2Z"/><path d="M9.5 9.2a2.6 2.6 0 0 1 5 .9c0 1.9-2.5 2-2.5 3.5M12 16h.01"/>`,
  listen: `<path d="M4 10h4l5-4v12l-5-4H4v-4Z"/><path d="M16 9a4 4 0 0 1 0 6M18.5 6.5a7.5 7.5 0 0 1 0 11"/>`,
  ...
  scene: `<path d="M4 8h16v11H4zM4 8l2-4h16l-2 4M8 4 6 8M14 4l-2 4M20 4l-2 4"/><path d="m10 12 5 2.5-5 2.5v-5Z"/>`,
  bookmark: `<path d="M6 4.5A1.5 1.5 0 0 1 7.5 3h9A1.5 1.5 0 0 1 18 4.5V21l-6-3.7L6 21V4.5Z"/>`,
  readiness: `<path d="M5 5h14a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-8l-5 4v-4H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2Z"/><path d="m9 11.5 2 2 4.5-4.5"/>`,
